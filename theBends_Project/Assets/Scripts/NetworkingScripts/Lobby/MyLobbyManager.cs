...
public class MyLobbyManager : NetworkLobbyManager
{
    ...
    public override void OnLobbyServerSceneChanged(string sceneName)
    {
        ...
        //AssignPlayerNames(players);

    }

    public void AssignRoleOfKillerToRandomPlayer(GameObject[] players)
    {
        ...
        GameObject.Find("NetworkGameLogicManager").GetComponent<NetworkGameLogicManager_AssignKiller>().CmdTellServerWhoTheKillerIs(players[randomNumber].gameObject.name);

        //Debug.Log("Killer assigned");
        //killerAssigned = true;
    }
    ...
    public override bool OnLobbyServerSceneLoadedForPlayer(GameObject lobbyPlayer, GameObject gamePlayer)
    {
        ...
        lobbyPlayer.transform.SetParent(gamePlayer.transform);
